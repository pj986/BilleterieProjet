...
public class InscriptionController {
    ...
    @FXML
    private void enregistrementInscription(javafx.event.ActionEvent event) {
        ...
        if (success) {
            ...
            System.out.println("[AUTH] Inscription OK → auto login");

            // 🔥 AUTO LOGIN
            Session.login(email, "client");

            // 🔥 DEBUG
            System.out.println("SESSION = " + Session.getEmail());

            // 🔥 REDIRECTION PROPRE
            app.SceneManager.switchScene(event, "/views/Home.fxml");
